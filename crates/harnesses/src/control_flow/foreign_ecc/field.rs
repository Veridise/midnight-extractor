...
#[entry("control-flow/select/foreign-ecc-field/point")]
#[harness(range_lookup(8))]
pub fn select_field_ecc(
    chip: &Fecf<F, G>,
...
#[entry("control-flow/cond_assert_equal/foreign-ecc-field/point")]
#[unit_harness(range_lookup(8))]
pub fn cond_assert_equal_field_ecc(
    chip: &Fecf<F, G>,
    layouter: &mut impl Layouter<F>,
...
#[entry("control-flow/cond_swap/foreign-ecc-field/point")]
#[harness(range_lookup(8))]
pub fn cond_swap_field_ecc(
    chip: &Fecf<F, G>,
    layouter: &mut impl Layouter<F>,
    (cond, a, b): (AssignedBit<F>, Afp<F, G>, Afp<F, G>),
